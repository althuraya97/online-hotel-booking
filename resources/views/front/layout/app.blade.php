                ...
                <div class="row">
                    ...
                    <div class="col-md-6 right-side">
                        ...
                        @if($global_page_data->cart_status == 1)
                            ...
                            <li class="menu"><a href="signin.html">{{ $global_page_data->signin_heading }}</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
                            ...
                            <ul class="navbar-nav ml-auto">        
                                ...
                                <li class="nav-item">
                                    ...
                                    @if($global_page_data->photo_gallery_status == 1)
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('photo_gallery')}}" class="nav-link">{{ $global_page_data->photo_heading }}</a>
                                        </li>
                                        @endif
                                        ...
                                        <li class="nav-item">
                                            <a href="{{ route('video_gallery')}}" class="nav-link">{{ $global_page_data->video_heading }}</a>
                                        </li>
                                        @endif
